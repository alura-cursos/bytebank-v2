...
describe('Requisições GET para API de transações', () => {
...
describe('Requisições POST para API de transações', () => {
    ...
    test('Deve retornar uma mensagem de erro ao falhar a requisição POST', async () => {
